...
export default function AuditPage() {
  ...
  const fetchFilters = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/audit/filters`);
  ...
  const fetchSummary = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/audit/summary`);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/audit/data?${params}`);
