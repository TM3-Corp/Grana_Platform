...
import DataFreshnessAlert from "./DataFreshnessAlert";
import {
  LayoutDashboard,
  TrendingUp,
  BarChart3,
  ...
  const navigation: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          name: "Por Bodega",
          href: "/dashboard/warehouse-inventory/by-warehouse",
          icon: Warehouse,
        },
        {
          name: "Planificación",
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          name: "Mapeo Canales",
          href: "/dashboard/channel-mappings",
          icon: ArrowLeftRight,
        },
      ],
    },
              ...
              if (item.isDropdown && item.subItems) {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <IconComponent
                        className={`w-4 h-4 ${!isDropActive ? colors.icon : ""}`}
                        strokeWidth={1.75}
                      />
                      <span>{item.name}</span>
                      <ChevronDown
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-gray-200 py-2">
                          {item.subItems.map((subItem) => {
                            ...
                            return (
                              ...
                              >
                                <SubIconComponent
                                  className={`w-4 h-4 ${!isItemActive ? colors.icon : ""}`}
                                  strokeWidth={1.75}
                                />
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            {session && (
              <>
                ...
                >
                  <User
                    className={`w-4 h-4 ${!isActive("/dashboard/profile") ? "text-emerald-500" : ""}`}
                    strokeWidth={1.75}
                  />
                  <span>Perfil</span>
                </Link>
                {userRole === "admin" && (
                  ...
                  >
                    <Users
                      className={`w-4 h-4 ${!isActive("/dashboard/users") ? "text-blue-500" : ""}`}
                      strokeWidth={1.75}
                    />
